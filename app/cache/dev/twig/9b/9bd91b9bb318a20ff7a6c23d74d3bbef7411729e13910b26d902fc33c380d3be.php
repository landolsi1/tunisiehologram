...
class __TwigTemplate_3792f5285ca1c590a5ef7c6c1e050981a71a5c17763aa9c349e2a54fdb2112aa extends Twig_Template
{
    ...
    <div style=\"padding-left: 200px; width: 900px; color: #73879C;\">
      ...
      <form class=\"form-horizontal form-label-left\" novalidate method=\"POST\"enctype=\"multipart/form-data\" action=\"";
        // line 12
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("esprit_hologram_update_product", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))), "html", null, true);
        echo "\">
...
{% block mainContent %}
    ...
    <div style=\"padding-left: 200px; width: 900px; color: #73879C;\">
      ...
      <form class=\"form-horizontal form-label-left\" novalidate method=\"POST\"enctype=\"multipart/form-data\" action=\"{{ path('esprit_hologram_update_product', {id: id})}}\">
      <div class=\"item form-group\">
                        <label class=\"control-label col-md-3 col-sm-3 col-xs-12\" for=\"name\">Product name :<span class=\"required\"></span>
                        </label>
...
{% endblock %}", "HologramBundle:Front:oneProduct.html.twig", "C:\\wamp64\\www\\tunisiehologram\\src\\HologramBundle/Resources/views/Front/oneProduct.html.twig");
    }
}
