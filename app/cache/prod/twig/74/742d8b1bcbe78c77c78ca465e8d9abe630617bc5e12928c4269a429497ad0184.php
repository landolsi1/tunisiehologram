...
class __TwigTemplate_89e50dd9073d614b8d59abd190ba231b2bfb7f47d36f63be90e6558e8876aebe extends Twig_Template
{
...
\t\t\t\t\t\t\t\t\t\t\t\t\t\t  <video width=\"800\" height=\"400\" controls>
                                 <source src=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bundle\TwigBundle\Extension\AssetsExtension')->getAssetUrl(("../web/Uploads/" . $this->getAttribute((isset($context["p"]) ? $context["p"] : null), "finalVideo", array()))), "html", null, true);
        echo "\" type=\"video/mp4\">
                           </video> </div>
\t\t\t\t\t\t\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t    </div>
...
\t\t\t\t\t\t\t\t\t    <ul class=\"side-bar-agile\">
        ...
        echo "</h4><p>";
        echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["p"]) ? $context["p"] : null), "productDate", array()), "d/m/Y"), "html", null, true);
        echo "</p></li>
\t\t\t\t\t\t\t                    </ul>
                                                                   </div>
                                </div>
...
";
    ...
    {
        return new Twig_Source("", "HologramBundle:Front:finalVideo.html.twig", "C:\\wamp\\www\\tunisiehologram\\src\\HologramBundle/Resources/views/Front/finalVideo.html.twig");
    }
}
